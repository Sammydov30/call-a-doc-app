<template>
  ...
  <div class="mx-auto col-xl-6 col-lg-6 col-md-6 d-flex flex-column mt-5 form-area">
    ...
    <div class="mt-5 form-contain card card-plain d-grid justify-content-center">
      ...
      <DoctorRegisterForm v-if="$route.query.status==='1'" :mydata="$route.query.email"/>
...
import DoctorRegisterForm from "@/components/forms/DoctorRegisterForm.vue";
import bgImg from "@/assets/img/bg/bg-3.jpg";
import logoimg from "@/assets/img/logo.png";
const body = document.getElementsByTagName("body")[0];
export default {
  name: "DContinueRegisterPage",
  components: {
    DoctorRegisterForm
  },
  data() {
