    ...
    <div class="card-body">
        ...
        <form role="form" class="text-start" @submit="register">
          ...
          <div v-show="step===2">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4 mt-2 mt-sm-0">
                    ...
                    <!-- <vsud-input type="text" placeholder="Last Name" v-model="user.surname" /> -->
                    <input v-model="user.surname" class="form-control form-input-h" type="text" placeholder="Surname">
                </div>
                <div class="col-md-4 mt-2 mt-sm-0">
          ...
          <div v-show="step===3">
            ...
            <div class="row mt-3">
                <div class="col-md-6 mt-2">
                    <label class="form-label-h">Body Weight</label>
                    <input v-model="user.weight" class="form-control form-input-h" type="text" placeholder="Body Weight">
                </div>
                <div class="col-md-6 mt-2">
                    <label class="form-label-h">Height</label>
                    <input v-model="user.height" class="form-control form-input-h" type="text" placeholder="Height">
                </div>
...
export default {
  ...
  methods: {
    register(ev) {
      ...
      this.loading = true;
      store
        .dispatch("pcontinueregister", this.user)
        .then(() => {
          this.loading = false;
          this.$router.push({
